...
OswConfigKeyDropDown settingDisplayDefaultWatchface("n", "Display", 
                                                    "Default Watchface ID (analog, digital, mix, binary, Dual-time, Step-tracking, Fitness-tracking)", "0,1,2,3,4,5,6", String(CONFIG_DEFAULT_WATCHFACE_INDEX));
OswConfigKeyBool settingDisplayDualHourTick("h2", "Display", "Display Dual-Time Hour Tick", "Show dual time hour tick", 1);
