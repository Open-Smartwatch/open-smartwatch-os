...
int OswDevices::QMC5883L::getMagnetometerX() { return qmc5883l.getX(); }
int OswDevices::QMC5883L::getMagnetometerY() { return qmc5883l.getY(); }
int OswDevices::QMC5883L::getMagnetometerZ() { return qmc5883l.getZ(); }
