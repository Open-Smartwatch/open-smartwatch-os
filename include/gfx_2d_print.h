...
class Graphics2DPrint : public Graphics2D, public Print {
  public:
    ...
    */
    ...
    void setTextCenterAligned() {
        text_x_alignment = _text_alignment::CENTER;
    }
    ...
    void setTextMiddleAligned() {
        text_y_alignment = _text_alignment::CENTER;
    }
    ...
    int16_t getTextCursorX() const {
        return cursor_x;
    }
    int16_t getTextCursorY() const {
        return cursor_y;
    };
