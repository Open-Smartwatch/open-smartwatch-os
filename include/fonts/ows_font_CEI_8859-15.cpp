...
#define PROGMEM
/**
 * @brief Default font used by the Open Smart Wacth
 * 
 * This font is a 5x7 pixel size using the ISO CEI 8859-15 ASCII table
 * 
 * https://fr.wikipedia.org/wiki/ISO/CEI_8859-15
 * 
 */
static const unsigned char OSWfont[] PROGMEM = {
		...
		0x7C, 0x12, 0x11, 0x12, 0x7C, //65 | x41 -> A
		...
		0x20, 0x54, 0x54, 0x78, 0x40,  //97 | x61 -> a
		...
		0x14, 0x3E, 0x55, 0x41, 0x22,  //164 | A4 -> €
		...
		0x78, 0x15, 0x12, 0x15, 0x78,  //196 | C4 -> Ä
		...
		0x7E, 0x01, 0x49, 0x56, 0x20, // DF -> ß
		0x20, 0x55, 0x56, 0x7C, 0x40, // 225 | E0 -> à 
		0x7E, 0x02, 0x02, 0x06, 0x06, // 226 | E1
		0x02, 0x7E, 0x02, 0x7E, 0x02, // 227 | E2
		0x63, 0x55, 0x49, 0x41, 0x63, // 228 | E3
		0x38, 0x44, 0x44, 0x3C, 0x04, // 229 | E4
		0x40, 0x7E, 0x20, 0x1E, 0x20, // 230 | E5
		0x06, 0x02, 0x7E, 0x02, 0x02, // 231 | E6
		0x0E, 0x51, 0x71, 0x11, 0x0A, // 231 | E7 -> ç
		0x38, 0x55, 0x56, 0x54, 0x18, // E8 -> è
		0x38, 0x56, 0x55, 0x54, 0x18, // E9 -> é
		0x30, 0x4A, 0x4D, 0x4D, 0x30, // EA -> ê
		0x30, 0x48, 0x78, 0x48, 0x30, // EB -> ë
		0xBC, 0x62, 0x5A, 0x46, 0x3D, // EC -> ì
		0x3E, 0x49, 0x49, 0x49, 0x00, // 238 | ED
		0x7E, 0x01, 0x01, 0x01, 0x7E, // 239 | EF
		0x2A, 0x2A, 0x2A, 0x2A, 0x2A, // 240 | F0
